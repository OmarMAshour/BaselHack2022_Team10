...
fields_we_want_in_sql = {"article_id": wine_data['code'],
                         ...
                         "originalPrice": wine_data["allPrices"][0]["originalPrice"],
                         "averageRating": wine_data["averageRating"],
                         "enjoyFrom": wine_data["enjoyFrom"],
                         "enjoyUntil": wine_data["enjoyUntil"],
                         ...
                         "grapesText": wine_data["grapesText"],
                         "imageUrls": ", ".join([i["url"] for i in wine_data["images"]]),
                         "name": wine_data["name"],
                         "name_de": wine_data["name_de"],
                         "name_en": wine_data["name_en"],
                         "name_fr": wine_data["name_fr"],
                         "name_it": wine_data["name_it"],
                         "servingTemperature": wine_data["servingTemperature"],
                         "specialInformation": wine_data["specialInformation"],
                         "specialInformation_de": wine_data["specialInformation_de"],
                         "specialInformation_en": wine_data["specialInformation_en"],
                         "specialInformation_fr": wine_data["specialInformation_fr"],
                         "specialInformation_it": wine_data["specialInformation_it"],
                         "specialInformations": wine_data["specialInformations"],
                         "tastingNotes": wine_data["tastingNotes"],
                         "tastingNotes_de": wine_data["tastingNotes_de"],
                         "tastingNotes_en": wine_data["tastingNotes_en"],
                         "tastingNotes_fr": wine_data["tastingNotes_fr"],
                         "tastingNotes_it": wine_data["tastingNotes_it"],
                         "typeOfSeal": wine_data["typeOfSeal"],
                         "url": wine_data["url"],
                         "vegan": wine_data["vegan"],
                         "vegetarian": wine_data["vegetarian"],
                         "wineAgeing": wine_data["wineAgeing"],
                         "wineCharacter": wine_data["wineCharacter"],
                         "wineMaker": wine_data["wineMaker"],
                         "wineOrigin": wine_data["wineOrigin"],
                         "wineOriginCountry": wine_data["wineOriginCountry"],
                         "wineOriginRegion": wine_data["wineOriginRegion"],
                         "yearOfVintage": wine_data["yearOfVintage"],
                         "wineFairProduct": wine_data["wineFairProduct"]}
